...
def store_digits(n):
    ...
    if n//10 == 0:
        ...
        t = str(n)
        return Link(int(t[0]), store_digits(int(t[1:])))
...
def is_bst(t):
    ...
    """
    "*** YOUR CODE HERE ***"
    def is_bst_helper(t, i_min, i_max):
        if len(t.branches)>2 or t.label > i_max or t.label < i_min:
            return False
        elif t.is_leaf():
            return True
        elif len(t.branches)==1:
            return is_bst_helper(t.branches[0], i_min, t.label) or \
                is_bst_helper(t.branches[0], t.label, i_max)
        else:
            return is_bst_helper(t.branches[0], i_min, t.label) and \
                is_bst_helper(t.branches[1], t.label, i_max)
    return is_bst_helper(t, -0x7ffffffff, 0x7fffffff)
